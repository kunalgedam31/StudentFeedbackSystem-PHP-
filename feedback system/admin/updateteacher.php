...
<html>
	...
	<div class="teacherhead"><center><font style="font-size:26px; color:gray; font-family:Times new roman; text-align:center; font-style:bold; "> UPDATE TEACHER <br><br><br> </font></div>
	<div class="main">
	<?php	
		$tid=@$_GET['ID'];
		$con = mysql_connect("localhost","root","");
		mysql_select_db("feedback_system", $con) or die(Mysql_error());
		$sql5 = "select * from teacher where tid='$tid' ";
		$result = mysql_query($sql5,$con) or die(Mysql_error());
		$records = Mysql_num_rows($result);
		$row6 = Mysql_fetch_array($result)
			
	?>
		<form method="post" action="#" style="text-align:right;">
			Teacher name  : <input type="input" value="<?php echo $row6['tname']; ?>" id="first_name" name="first_name" placeholder="teacher_name*" style="width:300px; padding:10px; borger:0px;" required>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br><br>
			User name :   <input type="input" value="<?php echo $row6['tuser']; ?>" id="user_name" name="user_name" placeholder="username*" style="width:300px; padding:10px; borger:0px;" required>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br><br>
			Password :    <input type="password" value="<?php echo $row6['tpass']; ?>" id="password" name="password" placeholder="password*" style="width:300px; padding:10px; borger:0px;" required>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br><br>
			Confirm password : <input type="password" value="<?php echo $row6['tconpass']; ?>" id="confirm_password" name="confirm_password" placeholder="confirm_password*" style="width:300px; padding:10px; borger:0px;" required>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br><br>
			<?php
			...
			branch :   <select id="branch" name="branch" placeholder="branch*" style="width:300px; padding:10px; borger:0px;" required>
						<option value="Select Branch" value="<?php echo $row6['tbranch']; ?>" disabled selected>--Select Branch--</option>
						<?php
			...
			class :   <select id="class" name="class" placeholder="class*" style="width:300px; padding:10px; borger:0px;" required>
						<option value="Select Class" value="<?php echo $row6['tclass']; ?>"disabled selected>--Select Class--</option>
						<?php
			...
			?>
			subject :   <select id="subject" name="subject" value="<?php echo $row6['tsubject']; ?>" placeholder="subject*" style="width:300px; padding:10px; borger:0px;" required>
	...
	if(isset($_POST['add']))
	{
		...
		if($pass!=$conpass)
		{
			echo '<script type="text/javascript">alert("Password does not matched");window.location=\'updateteacher.php\';</script>';
		}
		else
		{
			...
			$row = Mysql_fetch_array($query);
				...
				Mysql_query("update teacher set tname='$tname',tuser='$uname',tpass='$pass',tconpass='$conpass',tbranch='$branch',tclass='$class',tsubject='$subject' where tid='$tid'") or die(Mysql_error());
				
				echo '<script type="text/javascript">alert("Teacher is Updated successfully"); window.location=\'editteacher.php\';</script>';
